...
const PRODUCTION = {
  STATIC: {
    UPCOMING: {
      ...
      END: new Date("11/8/2023"),
    },
    PRELIVE: {
      START: new Date("11/09/2023"),
      END: new Date("10/10/2024"),
    },
    LIVE: {
  ...
  DYNAMIC: {
    "/admin/participants": new Date("10/13/2023"),
    "/admin/teams": new Date("10/13/2023"),
    ...
    "/admin/judging": new Date("10/13/2023"),
    "/admin/prizes": new Date("10/13/2023"),
    "/admin/statistics": new Date("10/13/2023"),
