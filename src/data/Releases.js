...
const PRODUCTION = {
  ...
  DYNAMIC: {
    "/admins/participants": new Date("10/01/2024"),
    "/admins/teams": new Date("10/01/2024"),
    "/admins/judges": new Date("10/09/2023"),
    "/admins/volunteers": new Date("10/09/2023"),
    "/admins/mentors": new Date("10/09/2023"),
    "/admins/admins": new Date("10/09/2023"),
    "/admins/committees": new Date("10/09/2023"),
    "/admins/feedback": new Date("10/01/2024"),
    "/admins/calendar": new Date("10/09/2023"),
    "/admins/messenger": new Date("10/01/2024"),
    "/admins/checkin": new Date("10/01/2024"),
    "/admins/judging": new Date("10/01/2024"),
    "/admins/prizes": new Date("10/01/2024"),
    "/admins/statistics": new Date("10/01/2024"),

    "/forms/particpants": new Date("10/01/2024"),
    "/forms/judges": new Date("10/09/2023"),
    "/forms/volunteers": new Date("10/09/2023"),
    "/forms/mentors": new Date("10/09/2023"),
    "/forms/admins": new Date("10/09/2023"),
    "/forms/committees": new Date("10/09/2023"),
    "/forms/feedback": new Date("10/01/2024"),
