...
const PRODUCTION = {
  ...
  DYNAMIC: {
    "/admin/participants": new Date("10/13/2024"),
    "/admin/teams": new Date("10/13/2024"),
    "/admin/judges": new Date("10/13/2023"),
    "/admin/volunteers": new Date("10/13/2023"),
    "/admin/mentors": new Date("10/13/2023"),
    "/admin/admins": new Date("10/13/2023"),
    "/admin/committees": new Date("10/13/2023"),
    "/admin/feedback": new Date("10/01/2024"),
    "/admin/calendar": new Date("10/13/2023"),
    "/admin/messenger": new Date("10/01/2024"),
    "/admin/checkin": new Date("10/13/2024"),
    "/admin/judging": new Date("10/13/2024"),
    "/admin/prizes": new Date("10/13/2024"),
    "/admin/statistics": new Date("10/13/2024"),

    "/forms/particpants": new Date("10/01/2024"),
    "/forms/judges": new Date("10/13/2023"),
    "/forms/volunteers": new Date("10/13/2023"),
    "/forms/mentors": new Date("10/13/2023"),
    "/forms/admins": new Date("10/13/2023"),
    "/forms/committees": new Date("10/13/2023"),
