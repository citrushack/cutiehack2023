      ...
      <div className="flex items-center w-full flex-col" data-cy="upload">
        {!file && (
          <label
            ...
            className="mt-3 flex flex-col items-center justify-center w-full h-fit rounded-lg cursor-pointer bg-cutie-gray-200/20 hover:bg-cutie-gray-200/30 duration-100"
          >
        ...
        {file && (
          <div
            className="flex items-center justify-between w-full my-2 bg-cutie-gray-200/20 px-2 py-2 rounded-md"
