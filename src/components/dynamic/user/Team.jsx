...
const Team = ({ user, setUser }) => {
  ...
  return (
    <div className="bg-white/10 rounded-lg p-4 gap-3 m-2 overflow-scroll max-h-[70vh] flex flex-col justify-start text-white">
      ...
      {team && (
        <>
          ...
          <div className="">
            ...
            {team.members.map((member, index) => (
              <p className="pl-3 m-0 flex items-center" key={index}>
                {member.name}
                <span className="ml-3 text-sm text-cutie-blue-100">
                  {member.email}
                </span>
              </p>
            ))}
          ...
          <div className="mt-3 pt-2 flex-grow">
            ...
            <div className="text-cutie-blue-100">
